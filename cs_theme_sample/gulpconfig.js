module.exports = {
  ...
  patternLab: {
    ...
    scssToJson: [
      ...
      {
        src: 'source/_patterns/00-base/20-layout/breakpoints/_breakpoints.scss',
        dest: 'source/_patterns/00-base/20-layout/breakpoints/breakpoints.json',
        lineStartsWith: '$bp-',
        allowVarValues: false
      },
      {
  ...
  drupal: {
    enabled: true,
    themeFile: 'phoenix_reborn.info.yml',
